        ...
        <div class="col-span-3">
            <div class="relative justify-self-center">
                ...
                <div class="flex w-full justify-center">
                    ...
                    <h3 class="pb-2 font-bold text-lg text-white text-center">Formulir Pendaftaran Naik Qism</h3>

                </div>
                <div class="flex w-full justify-center">

                    <h3 class="pb-2 font-bold text-lg text-white text-center">Ma'had Ta'dzimussunnah Sine Ngawi</h3>
